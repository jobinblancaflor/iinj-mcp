...
class Demo_auth_model extends CI_Model {
	...
	function register_account()
	{
		...
		$validation_rules = array(
			...
			array('field' => 'register_designation', 'label' => 'Designation', 'rules' => 'required'),
			array('field' => 'register_birthday', 'label' => 'Birthday', 'rules' => 'required'),
			array('field' => 'register_congregation', 'label' => 'Congregation', 'rules' => 'required'),			
		...
		if ($this->form_validation->run())
		{
			...
			$profile_data = array(
				...
				'upro_birthday' => $this->input->post('register_birthday'),
				'upro_congregation' => $this->input->post('register_congregation'),
				'upro_designation' => $this->input->post('register_designation')
			);
	...
	function add_census()
	{
		...
		// The custom rules 'identity_available' and 'validate_password' can be found in '../libaries/MY_Form_validation.php'.
		$validation_rules = array(
			array('field' => 'census_designation', 'label' => 'Designation', 'rules' => 'required'),
			array('field' => 'census_first_name', 'label' => 'First Name', 'rules' => 'required'),
			array('field' => 'census_middle_name', 'label' => 'Middle Name', 'rules' => 'required'),
			array('field' => 'census_last_name', 'label' => 'Last Name', 'rules' => 'required'),
			array('field' => 'census_gender', 'label' => 'Gender', 'rules' => 'required'),
			array('field' => 'census_birthday', 'label' => 'Birthday', 'rules' => 'required'),
			array('field' => 'census_congregation', 'label' => 'Congregation', 'rules' => 'required'),			
			array('field' => 'census_phone_number', 'label' => 'Phone Number', 'rules' => 'required')
		);
