	...
	<div class="col-lg-12" >
		...
		<fieldset class="container">
			...
			<h2> Attendance for Congregation of <?php echo $row["congregation"]; ?>
				<a href=""  class="btn btn-success text-white pull-right" data-toggle="modal" data-target="#myModal">Add Visitor</a> 
			...
			<table class="table-striped">
				...
				<tr>
					<td><?php echo $row["census_first_name"].' '.$row["census_middle_name"].' '.$row["census_last_name"]; ?></td>
			...
			<table class="table-striped">
				...
				<tr>
					...
					<td><?php echo $row["time"]; ?></td>
					<td><a class="btn btn-primary text-white" href="">Present</a></td>
				</tr>
				<?php } ?>
			</table>			
			<?php } ?>
